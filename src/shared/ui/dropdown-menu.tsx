    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          data-[state=closed]:overflow-hidden data-open:animate-in
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        pl-1.5 text-sm outline-hidden select-none focus:bg-accent
        focus:text-accent-foreground focus:**:text-accent-foreground
        data-inset:pl-7 data-disabled:pointer-events-none
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        rounded-lg bg-popover p-1 text-popover-foreground shadow-lg ring-1
