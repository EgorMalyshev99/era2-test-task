...
const buttonVariants = cva(
  ...
  in-data-[slot=button-group]:first:rounded-l-full
  in-data-[slot=button-group]:last:rounded-r-full`,
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground hover:bg-primary/80',
        outline: `border-border bg-background text-era-fg-dim hover:bg-muted
      ...
      size: {
        default: `h-10 gap-1.5 px-4 text-sm font-medium
        ...
        sm: `h-8 gap-1 px-2.5 text-[13px] font-medium
        has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5
        [&_svg:not([class*='size-'])]:size-3.5`,
        lg: `h-12 gap-1.5 px-2.5 text-[13px] font-medium
